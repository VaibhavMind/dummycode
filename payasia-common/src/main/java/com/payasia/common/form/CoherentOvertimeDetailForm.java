 ...
 *
 */
public class CoherentOvertimeDetailForm implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6352896795089247093L;
	private Long coherentOvertimeApplicationReviewerId;
	...
	private Long coherentOvertimeApplicationId;
	...
	public Long getCoherentOvertimeApplicationReviewerId() {
		return coherentOvertimeApplicationReviewerId;
	}
	public void setCoherentOvertimeApplicationReviewerId(
			Long coherentOvertimeApplicationReviewerId) {
		this.coherentOvertimeApplicationReviewerId = coherentOvertimeApplicationReviewerId;
	}
	...
	public Long getCoherentOvertimeApplicationId() {
		return coherentOvertimeApplicationId;
	}
	public void setCoherentOvertimeApplicationId(Long coherentOvertimeApplicationId) {
		this.coherentOvertimeApplicationId = coherentOvertimeApplicationId;
	}
