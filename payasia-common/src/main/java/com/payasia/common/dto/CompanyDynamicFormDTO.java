...
public class CompanyDynamicFormDTO implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 1003720537381820333L;
	...
	private Long savedDynamicRecordId;
	...
	public Long getSavedDynamicRecordId() {
		return savedDynamicRecordId;
	}
	public void setSavedDynamicRecordId(Long savedDynamicRecordId) {
		this.savedDynamicRecordId = savedDynamicRecordId;
	}
