...
public class TextPaySlipDTO {
	...
	private List<SummarySectionTextPayslipDTO> summaryLeftFourColSectionDTOList;
	...
	public List<SummarySectionTextPayslipDTO> getSummaryLeftFourColSectionDTOList() {
		return summaryLeftFourColSectionDTOList;
	}

	public void setSummaryLeftFourColSectionDTOList(
			List<SummarySectionTextPayslipDTO> summaryLeftFourColSectionDTOList) {
		this.summaryLeftFourColSectionDTOList = summaryLeftFourColSectionDTOList;
	}
