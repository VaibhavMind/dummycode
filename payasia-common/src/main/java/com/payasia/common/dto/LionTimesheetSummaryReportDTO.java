...
public class LionTimesheetSummaryReportDTO implements Serializable{
	...
	private String employeeReviewer1Number;
	...
	public String getEmployeeReviewer1Number() {
		return employeeReviewer1Number;
	}
	public void setEmployeeReviewer1Number(String employeeReviewer1Number) {
		this.employeeReviewer1Number = employeeReviewer1Number;
	}
