...
public class LundinDailyPaidTimesheetDTO implements Serializable{
	...
	private Double annualCumManDays;
	private Double annualCumAmount;
	private String costCategoryCode;
	private String costCategoryDesc;
	private Double totalManDays;
	private Double dailyRate;
	private Double totalAmount;
	private String dynamicFormRecordColName;
	private String dynamicFormTableRecordColName;
	private String dailRateFormId;
...
private List<LeaveReportCustomDataDTO> reportCustomDataDTOs;
	...
	public Double getAnnualCumAmount() {
		return annualCumAmount;
	}
	public void setAnnualCumAmount(Double annualCumAmount) {
		this.annualCumAmount = annualCumAmount;
	}
	...
	public Double getAnnualCumManDays() {
		return annualCumManDays;
	}
	public void setAnnualCumManDays(Double annualCumManDays) {
		this.annualCumManDays = annualCumManDays;
	}
	...
	public String getDynamicFormRecordColName() {
		return dynamicFormRecordColName;
	}
	public void setDynamicFormRecordColName(String dynamicFormRecordColName) {
		this.dynamicFormRecordColName = dynamicFormRecordColName;
	}
	public String getDynamicFormTableRecordColName() {
		return dynamicFormTableRecordColName;
	}
	public void setDynamicFormTableRecordColName(
			String dynamicFormTableRecordColName) {
		this.dynamicFormTableRecordColName = dynamicFormTableRecordColName;
	}
	public String getDailRateFormId() {
		return dailRateFormId;
	}
	public void setDailRateFormId(String dailRateFormId) {
		this.dailRateFormId = dailRateFormId;
	}
	...
	public String getCostCategoryDesc() {
		return costCategoryDesc;
	}
	public void setCostCategoryDesc(String costCategoryDesc) {
		this.costCategoryDesc = costCategoryDesc;
	}
