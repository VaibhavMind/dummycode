...
public class EmployeeClaimAdjustmentsHeaderDTO implements Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 6002299005181910598L;
	...
	public boolean equals(Object obj) {
		if(obj !=null && obj instanceof EmployeeClaimAdjustmentsHeaderDTO){
			EmployeeClaimAdjustmentsHeaderDTO comp=(EmployeeClaimAdjustmentsHeaderDTO)obj;
