...
/**
 * The persistent class for the Claim_Reviewer_Detail_View database table.
 * 
 */
@Entity
@Table(name = "Claim_Reviewer_Detail_View")
public class ClaimReviewerDetailView implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private ClaimReviewerDetailViewPK claimReviewerDetailViewPK;

	public ClaimReviewerDetailViewPK getClaimReviewerDetailViewPK() {
		return claimReviewerDetailViewPK;
	}

	public void setClaimReviewerDetailViewPK(
			ClaimReviewerDetailViewPK claimReviewerDetailViewPK) {
		this.claimReviewerDetailViewPK = claimReviewerDetailViewPK;
	}

	@Column(name = "Claim_Template_Name")
	...
	public ClaimReviewerDetailView() {
	}

	public String getClaimTemplateName() {
		return this.claimTemplateName;
	}
