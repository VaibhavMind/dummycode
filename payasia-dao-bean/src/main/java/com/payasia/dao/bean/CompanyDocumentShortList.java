...
/**
 * The persistent class for the Company_Document_Short_List database table.
 * 
 */
@Entity
@Table(name = "Company_Document_Short_List")
public class CompanyDocumentShortList extends CompanyBaseEntity implements
		Serializable {
	...
	public CompanyDocumentShortList() {
	}
