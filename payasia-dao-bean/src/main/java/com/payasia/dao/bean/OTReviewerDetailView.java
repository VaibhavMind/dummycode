...
/**
 * The persistent class for the OT_Reviewer_Detail_View database table.
 * 
 */
@Entity
@Table(name = "OT_Reviewer_Detail_View")
public class OTReviewerDetailView implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private OTReviewerDetailViewPK otReviewerDetailViewPK;
	...
	public OTReviewerDetailView() {
	}

	public OTReviewerDetailViewPK getOtReviewerDetailViewPK() {
		return otReviewerDetailViewPK;
	}

	public void setOtReviewerDetailViewPK(
			OTReviewerDetailViewPK otReviewerDetailViewPK) {
		this.otReviewerDetailViewPK = otReviewerDetailViewPK;
	}
