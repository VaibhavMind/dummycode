 ...
 */
@Entity
@Table(name = "HRIS_Reviewer_Detail_View")
public class HRISReviewerDetailView implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private HRISReviewerDetailViewPK hrisReviewerDetailViewPK;
	...
	public HRISReviewerDetailViewPK getHrisReviewerDetailViewPK() {
		return hrisReviewerDetailViewPK;
	}

	public void setHrisReviewerDetailViewPK(
			HRISReviewerDetailViewPK hrisReviewerDetailViewPK) {
		this.hrisReviewerDetailViewPK = hrisReviewerDetailViewPK;
	}
